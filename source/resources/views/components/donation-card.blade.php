    ...
    <div class="p-5">
        ...
        <div class="mt-2 space-y-1">
            <p class="text-xs text-[#5a8a7a] flex items-center gap-2">
                <span class="opacity-70">🎂</span> Age: {{ $age }} years
            </p>
            <p class="text-xs text-[#5a8a7a] flex items-center gap-2">
        ...
        <div class="mt-6 flex items-center justify-between">
            <div class="text-[#c59436] font-bold">
                <span class="text-sm">৳</span><span class="text-lg">{{ number_format($amount) }}</span><span class="text-[10px] text-[#5a8a7a] font-normal">/month</span>
            </div>
